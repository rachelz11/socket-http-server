...
def response_method_not_allowed():
    ...
    return b"\r\n".join([
        ...
        b'',
        b"you con't do it on this server",
    ])
...
def response_path(path):
    ...
    mime_type = b''
    # Cases:
    # *The path points to a directory INSIDE OF webroot. eg:'/' or '/images/'
    ...
    #* The path dosn't point to an existing directory or file INSIDE OF webroot
    else:
        raise NameError
